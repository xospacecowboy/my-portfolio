...
export default function RPGChat() {
  ...
  return (
    <div 
      className="absolute inset-0 flex flex-col bg-black/80 text-gray-100 overflow-hidden" 
      onWheel={(e) => e.stopPropagation()}
      onTouchMove={(e) => e.stopPropagation()}
    >
      <div 
        className="flex-1 overflow-y-auto px-4 pt-4 space-y-4 no-scrollbar scroll-smooth"
      ...
      <form 
        ...
        className="absolute bottom-0 left-0 right-0 border-t border-white/10 bg-black/95 backdrop-blur-sm"
        onWheel={(e) => e.stopPropagation()}
        onTouchMove={(e) => e.stopPropagation()}
      >
        <div className="flex gap-2 p-4">
          ...
          <button
            ...
            className="px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg transition-colors whitespace-nowrap"
          >
            Send
          </button>
        </div>
