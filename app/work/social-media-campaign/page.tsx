...
const projectData = {
  ...
  results: "In less than five months, the strategy drove 4MM+ new followers and a significant rise in positive sentiment, successfully reshaping EA’s public image and reinforcing its player-first commitment.",
  images: [
    {
