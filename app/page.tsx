              ...
              >
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-white text-deep-grey px-6 py-3 text-lg font-medium hover:bg-pastel-blue hover:text-white transition-colors"
                  >
                    AKA OXYTOCINS
                  </motion.button>
                  <p className="text-xl text-white/80 font-jetbrains-mono">
                    Creative Strategy & Digital Innovation
                  </p>
                </div>
              </motion.div>
            </div>
